...
const FEATURES = [
  ...
  { icon: Storefront, text: 'Digital business profile' },
      ...
      <div className="max-w-6xl mx-auto rounded-3xl bg-gradient-to-br from-stone-900 via-stone-900 to-orange-950 p-8 sm:p-12 lg:p-14 overflow-hidden relative">
        ...
        <div className="relative grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            >
              Grow your salon, parlour, or unisex studio
            </h2>
            <p className="text-stone-300 leading-relaxed mb-6">
              Take your business online — get discovered by customers nearby, accept appointments
              24/7, and manage bookings digitally. List for free in Jammu &amp; Kashmir.
            </p>
