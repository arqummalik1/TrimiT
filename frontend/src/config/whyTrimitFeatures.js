...
export const WHY_TRIMIT_FEATURES = [
  {
    icon: Lightning,
  ...
  },
  {
    ...
    description: 'See open times in real time so you never double-book.',
  ...
  },
  {
    icon: Wallet,
    title: 'Pay at salon',
    description: 'Flexible payment — pay at the salon when that works for you.',
    accent: 'from-stone-50 to-emerald-50/60',
  },
  {
    icon: Clock,
    title: '24/7 booking',
