...
export const DOWNLOAD_APP_URL =
  (process.env.REACT_APP_DOWNLOAD_APP_URL || '').trim() || APK_DOWNLOAD_FOLDER_URL;
...
export const PLAY_STORE_URL =
  (process.env.REACT_APP_PLAY_STORE_URL || '').trim() || DOWNLOAD_APP_URL;
...
export const IS_APK_DRIVE_DOWNLOAD =
  ...
  PLAY_STORE_URL.includes('drive.google.com');
