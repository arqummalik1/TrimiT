-- ============================================================================
-- Fix reschedule_booking_atomic time comparisons
-- ============================================================================
-- Bookings may store time_slot as 'HH:MM' or 'HH:MM:SS'. String equality
-- caused false "slot full" / availability bugs. Compare as TIME instead.
-- ============================================================================
